...
-- AddForeignKey
ALTER TABLE "doctor_specialites" ADD CONSTRAINT "doctor_specialites_specialitiesId_fkey" FOREIGN KEY ("specialitiesId") REFERENCES "specialites"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
